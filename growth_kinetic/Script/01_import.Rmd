...
format_time <- function(df) {
  ...
  #'
  #' This function takes a data frame with a POSIXct column named 'Time' and adds a new column 'time_h' that represents the number of hours since the first time point in the 'Time' column.
  #'

...
- **OD&fluorescence_kinetic**: Script to parse data from an experiment where OD and fluorescence where measured in a microplate with supplementation of an inducer and/or an effector molecule.
...
- **growth_kinetic**: Script to parse data from a simple growth experiment in a microplate with supplementation of ligands of choice.
